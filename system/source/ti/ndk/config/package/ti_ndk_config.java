...
public class ti_ndk_config
{
    ...
    void Global$$CONSTS()
    {
        ...
        om.bind("ti.ndk.config.Global.defaultBootTaskStackSize", 2048L);
    ...
    void Global$$TYPES()
    {
        ...
        po.init("ti.ndk.config.Global.Module", $$Module);
                ...
                po.addFld("defaultBootTaskStackSize", Proto.Elm.newCNum("(xdc_Int)"), 2048L, "rh");
        ...
        po.addFld("bootTaskStackSize", Proto.Elm.newCNum("(xdc_Int)"), 2048L, "wh");
        po.addFld("enableCodeGeneration", $$T_Bool, true, "wh");
        po.addFld("autoOpenCloseFD", $$T_Bool, false, "wh");
        po.addFld("maxSockFileDesc", Proto.Elm.newCNum("(xdc_Int)"), 10L, "wh");
